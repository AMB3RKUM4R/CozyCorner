...
const AccountPage = () => {
    return (
        <div className="w-full max-w-7xl mx-auto py-16 px-4 md:px-10">
            <h1 className="text-4xl font-semibold text-white mb-4">Cozy Furniture Purchased</h1>
            <p className="text-lg text-gray-400 mb-12">
                Manage your purchased and customized Furnitures.
            </p>
                    ...
                    >
                        <div className="flex items-center gap-6 mb-4 md:mb-0">
                            <Image
                                ...
                                onError={(e) => { e.currentTarget.src = '/6.jpg'; }}
                            />
                            <div>
